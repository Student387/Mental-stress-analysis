...
def get_top_contributors(stress_level, responses):
    """
    Returns the top factors that lead to the specific stress level.
    - If Low: Returns the 'Protective' (Positive) factors.
    - If Medium/High: Returns the 'Risk' (Negative) factors.
    """
    factors = []
    ...
    if stress_level == 'Low':
        ...
        if r.get('living_conditions') == 'good': factors.append("Stable Environment")
